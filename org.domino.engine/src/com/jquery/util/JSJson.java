...
public class JSJson {
	...
	public static final JSJson wrap(Object o) throws JsonException {
		...
		throw new JsonException(null,"The value {0} is neither a JavaScript object or array");
	}
	...
	private FBSObject asObject() throws JsonException {
		...
		throw new JsonException(null,"JavaScript value is not an object");
	}
	...
	private void putProperty(String propertyName, FBSValue v) throws JsonException {
		try {
			...
			throw new JsonException(ex,"Error while setting object property {0}", propertyName); // $NLS-JsonJavaScriptFactory.Errorwhileaccessingobjectproperty-1$
		}
	}
	...
	public JSJson getObject(String propertyName) throws JsonException {
		...
		throw new JsonException(null,"Property {0} is not an object",propertyName);
	}
	...
	private ArrayObject asArray() throws JsonException {
		...
		throw new JsonException(null,"JavaScript value is not an array");
	}
	private FBSValue getProperty(int index) throws JsonException {
		try {
			return asArray().get(index);
		} catch(InterpretException ex) {
			throw new JsonException(ex,"Error while accessing indexed property {0}", index);
		}
	}
	...
	public JSJson getObject(int index) throws JsonException {
		...
		throw new JsonException(null,"Index {0} is not an object",index);
	}
